!(function (e) {
      ...
      const i = (t.Endpoints = {
        ...
        Guild: e => {
          ...
          return {
            ...
            Integration: e => `${t}/integrations/${e}`,
          };
        },
        channels: '/channels',
        Channel: e => {
        ...
        CDN: e => ({
          ...
          Asset: t => `${e}/assets/${t}`,
          Avatar: (t, s) =>
            `${e}/avatars/${t}/${s}.${s.startsWith('a_') ? 'gif' : 'png?size=2048'}`,
  ...
  function (e, t, s) {
    ...
    (Collection.prototype.findAll = i.deprecate(
      ...
      (Collection.prototype.find = function (e, t) {
        if ('string' == typeof e) {
          if (
            (((e, ...t) => console.warn('Collection#find: pass a function instead', t))(
              0,
              'DeprecationWarning',
            ),
            void 0 === t)
      ...
      (Collection.prototype.findKey = function (e, t) {
        if ('string' == typeof e) {
          if (
            (((e, ...t) =>
              console.warn('Collection#findKey: pass a function instead', t))(
              0,
              'DeprecationWarning',
            ),
            void 0 === t)
  ...
  function (e, t, s) {
    (function (t) {
      ...
      e.exports = class Util {
        ...
        static parseEmoji(e) {
          if ((e.includes('%') && (e = decodeURIComponent(e)), !e.includes(':')))
  ...
  function (e, t, s) {
    ...
    e.exports = class SnowflakeUtil {
      ...
      static generate(e = Date.now()) {
        if ((e instanceof Date && (e = e.getTime()), 'number' != typeof e || isNaN(e)))
          throw new TypeError(
  ...
  function (e, t, s) {
    ...
    class Permissions extends i {
      constructor(e, t) {
        super('object' != typeof e || e instanceof Array ? e : t),
          Object.defineProperty(this, '_member', {
            writable: !0,
            value: 'object' != typeof e || e instanceof Array ? null : e,
          });
      }
      get member() {
        return this._member;
    ...
    (Permissions.FLAGS = {
      ...
      Object.defineProperty(Permissions.prototype, 'member', {
        ...
        set: n.deprecate(
          Object.getOwnPropertyDescriptor(Permissions.prototype, 'member').set,
          'EvaluatedPermissions#member is deprecated',
        ),
      }),
    ...
    (function (e) {
      ...
      function c(e, s, i) {
        ...
        if (0 === o.length) {
          ...
          if (v(s)) return e.stylize(RegExp.prototype.toString.call(s), 'regexp');
      ...
      (t.debuglog = function (s) {
        if (
          (_(r) && (r = Object({ __DISCORD_WEBPACK__: 'true' }).NODE_DEBUG || ''),
          (s = s.toUpperCase()),
          !o[s])
        )
  ...
  function (e, t, s) {
    ...
    class User {
      ...
      get avatarURL() {
        return this.avatar
          ? n.Endpoints.User(this).Avatar(this.client.options.http.cdn, this.avatar)
          : null;
      }
  ...
  function (e, t, s) {
    ...
    class Game {
      constructor(e, t) {
        Object.defineProperty(this, 'presence', { value: t }),
          ...
          e.emoji
            ? ((this.emoji = new r(
                { message: { client: this.presence.client } },
                e.emoji,
              )),
      ...
      equals(e) {
        return (
          this === e ||
          (e && this.name === e.name && this.type === e.type && this.url === e.url)
        );
      }
    }
    ...
    (t.Presence = class Presence {
      constructor(e = {}, t) {
        Object.defineProperty(this, 'client', { value: t }), this.update(e);
      }
      update(e) {
        (this.status = e.status || this.status || 'offline'),
          (this.game = e.game ? new Game(e.game, this) : null),
          e.activities
            ? (this.activities = e.activities.map(e => new Game(e, this)))
            : e.activity || e.game
            ? (this.activities = [new Game(e.activity || e.game, this)])
            : (this.activities = []),
      ...
      equals(e) {
        return (
          ...
          (e &&
            ...
            this.activities.every((t, s) => t.equals(e.activities[s])) &&
    ...
    e.exports = class Invite {
      ...
      setup(e) {
        (this.guild = this.client.guilds.get(e.guild.id) || new i(this.client, e.guild)),
          ...
          (this.channel =
            this.client.channels.get(e.channel.id) || new n(this.client, e.channel)),
          (this.createdTimestamp = new Date(e.created_at).getTime());
      }
      get createdAt() {
        return new Date(this.createdTimestamp);
  ...
  function (e, t, s) {
    ...
    e.exports = class GuildChannel extends i {
      ...
      overwritesFor(e, t = !1, s = null) {
        if ((t || (e = this.client.resolver.resolveGuildMember(this.guild, e)), !e))
          return [];
        s = s || e.roles;
        const i = [];
        let n, r;
      ...
      replacePermissionOverwrites({ overwrites: e, reason: t } = {}) {
        return this.edit({ permissionOverwrites: e, reason: t }).then(() => this);
      }
      overwritePermissions(e, t, s) {
        ...
        else if (((e = this.client.resolver.resolveUser(e)), (i.type = 'member'), !e))
      ...
      setParent(e, t) {
        return (
          (e = this.client.resolver.resolveChannelID(e)), this.edit({ parent: e }, t)
        );
      }
      setTopic(e, t) {
      ...
      clone(e = {}, t = !0, s = !0, i) {
        return (
          (arguments.length > 1 || 'string' == typeof e) &&
            ...
            (e = {
              name: e,
              permissionOverwrites: t ? this.permissionOverwrites : null,
              topic: s ? this.topic : null,
              reason: i || null,
            })),
          c.mergeDefault(
            {
          ...
          this.guild.createChannel(e.name, e)
        );
      }
      fetchInvites() {
    ...
    (function (e) {
        ...
        return q(
          (function (e, t) {
            for (var s, i, n, r = [], o = 0; o < e.length && !((t -= 2) < 0); ++o)
              (s = e.charCodeAt(o)), (i = s >> 8), (n = s % 256), r.push(n), r.push(i);
            return r;
          })(t, e.length - s),
          e,
          s,
      ...
      (l.prototype.slice = function (e, t) {
        ...
        (l.prototype.readInt8 = function (e, t) {
          return (
            t || U(e, 1, this.length), 128 & this[e] ? -1 * (255 - this[e] + 1) : this[e]
          );
        }),
  ...
  function (e, t, s) {
      ...
      if (
        ...
        void 0 === (r = e._events)
          ...
          : (void 0 !== r.newListener &&
              (e.emit('newListener', t, s.listener ? s.listener : s), (r = e._events)),
            (o = r[t])),
        void 0 === o)
      )
        (o = r[t] = s), ++e._eventsCount;
      else if (
        ('function' == typeof o
          ? (o = r[t] = i ? [s, o] : [o, s])
          : i
    ...
    Object.defineProperty(a, 'defaultMaxListeners', {
      ...
      (a.prototype.once = function (e, t) {
        return h(t), this.on(e, d(this, e, t)), this;
      }),
      (a.prototype.prependOnceListener = function (e, t) {
        return h(t), this.prependListener(e, d(this, e, t)), this;
      }),
      (a.prototype.removeListener = function (e, t) {
        var s, i, n, r, o;
        if ((h(t), void 0 === (i = this._events))) return this;
  ...
  function (e, t, s) {
    ...
    e.exports = class RichEmbed {
      ...
      setColor(e) {
        return o || (o = s(33)), (this.color = o.resolveColor(e)), this;
      }
      setAuthor(e, t, s) {
        return (this.author = { name: r.resolveString(e), icon_url: t, url: s }), this;
      }
      ...
      addField(e, t, s = !1) {
        ...
        return this.fields.push(this.constructor.normalizeField(e, t, s)), this;
      }
      addBlankField(e = !1) {
      ...
      spliceFields(e, t, ...s) {
        if (s) {
          const i = ({ name: e, value: t, inline: s }) =>
            this.constructor.normalizeField(e, t, s);
          this.fields.splice(e, t, ...s.map(i));
        } else this.fields.splice(e, t);
        return this;
      }
      setThumbnail(e) {
      ...
      get length() {
        return (
          ...
          (this.fields.length >= 1
            ? this.fields.reduce((e, t) => e + t.name.length + t.value.length, 0)
            : 0) +
      ...
      toJSON() {
        return {
          ...
          color: this.color,
          fields: this.fields
            ? this.fields.map(e => ({ name: e.name, value: e.value, inline: e.inline }))
            : null,
      ...
      static normalizeField(e, t, s = !1) {
        ...
        if ((t = r.resolveString(t)).length > 1024)
      ...
      class TextBasedChannel {
        ...
        send(t, s) {
          ...
          if (
            ...
            s instanceof l && (s.reply && (s.reply = void 0), (s = { embed: s })),
            (s.reply = n),
            s.embed &&
              (s.embed.file &&
                (s.files ? s.files.push(s.embed.file) : (s.files = [s.embed.file])),
              s.embed.files &&
                (s.files
                  ? (s.files = s.files.concat(s.embed.files))
                  : (s.files = s.embed.files))),
            s.file && (s.files ? s.files.push(s.file) : (s.files = [s.file])),
            s.embed && (s.embed = new l(s.embed).toJSON()),
            s.files)
          ) {
            for (let t = 0; t < s.files.length; t++) {
              let n = s.files[t];
              (n && 'string' != typeof n && !e.isBuffer(n)) || (n = { attachment: n }),
                n.name
                  ...
                  : n instanceof a
                  ? (n = { attachment: n.file, name: i.basename(n.file) || 'file.jpg' })
                  : (n.name = 'file.jpg'),
                (s.files[t] = n);
            }
            return Promise.all(
        ...
        bulkDelete(e, t = !1) {
          ...
          if (!isNaN(e))
            return this.fetchMessages({ limit: e }).then(e => this.bulkDelete(e, t));
    ...
    e.exports = class Message {
      ...
      setup(e) {
        ...
        (this.mentions = new i(
          ...
          e.member &&
            this.guild &&
            this.author &&
            !this.guild.members.has(this.author.id) &&
            this.guild._addMember(Object.assign(e.member, { user: this.author }), !1),
      ...
      patch(e) {
        ...
        if (
          ...
          (this.embeds =
            'embeds' in e ? e.embeds.map(e => new r(this, e)) : this.embeds.slice()),
          'attachments' in e)
        ) {
          this.attachments = new c();
          for (const t of e.attachments) this.attachments.set(t.id, new n(this, t));
      ...
      get url() {
        return `https://discordapp.com/channels/${this.guild ? this.guild.id : '@me'}/${
          this.channel.id
        }/${this.id}`;
      }
      get cleanContent() {
      ...
      get deletable() {
        return (
          ...
          (this.author.id === this.client.user.id ||
            (this.guild &&
              this.channel.permissionsFor(this.client.user).has(d.FLAGS.MANAGE_MESSAGES)))
        );
      }
      get pinnable() {
        return (
      ...
      isMemberMentioned(e) {
        return (
          ...
          !!this.mentions.everyone ||
            ...
            !!(e instanceof p && e.roles.some(e => this.mentions.roles.has(e.id)))
        );
      }
      edit(e, t) {
        return (
      ...
      reply(e, t) {
        return (
          t || 'object' != typeof e || e instanceof Array
            ? t || (t = {})
            : ((t = e), (e = '')),
          this.channel.send(e, Object.assign(t, { reply: this.member || this.author }))
        );
      }
      acknowledge() {
      ...
      suppressEmbeds(e = !0) {
        ...
        return (
          e ? t.add(m.FLAGS.SUPPRESS_EMBEDS) : t.remove(m.FLAGS.SUPPRESS_EMBEDS),
          this.edit(void 0, { flags: t })
        );
      }
      equals(e, t) {
        if (!e) return !1;
      ...
      _addReaction(e, t) {
        ...
        return (
          this.reactions.has(s)
            ? (i = this.reactions.get(s)).me || (i.me = t.id === this.client.user.id)
      ...
      _removeReaction(e, t) {
        ...
        if (this.reactions.has(s)) {
          ...
          if (!t) return this.reactions.delete(s), e;
          if (e.users.has(t.id))
            return (
              e.users.delete(t.id),
              e.count--,
    ...
    class Emoji {
      ...
      fetchAuthor() {
        return this.managed
          ...
          : this.guild.me.permissions.has(r.FLAGS.MANAGE_EMOJIS)
          ? this.client.rest
              .makeRequest('get', i.Endpoints.Guild(this.guild).Emoji(this.id), !0)
              .then(e => this.client.dataManager.newUser(e.user))
          : Promise.reject(
              new Error(
                `Client must have Manage Emoji permission in guild ${this.guild} to see emoji authors.`,
              ),
            );
      }
      addRestrictedRole(e) {
  ...
  function (e, t, s) {
    ...
    class GuildMember {
      ...
      setup(e) {
        (this.serverDeaf = e.deaf),
          ...
          (this.selfStream = e.self_stream || !1),
          ...
          e.premium_since &&
            (this.premiumSinceTimestamp = new Date(e.premium_since).getTime()),
          (this.user = e.user),
          (this._roles = e.roles);
      }
      get joinedAt() {
      ...
      addRole(e, t) {
        return (
          ...
          e
            ...
            : Promise.reject(
                new TypeError('Supplied parameter was neither a Role nor a Snowflake.'),
              )
        );
      }
      addRoles(e, t) {
    ...
    i.applyToClass(GuildMember),
      ...
      (GuildMember.prototype.missingPermissions = l.deprecate(
        GuildMember.prototype.missingPermissions,
  ...
  function (e, t) {
    class BitField {
      ...
      serialize(...e) {
        const t = {};
        for (const s of Object.keys(this.constructor.FLAGS))
          t[s] = this.has(this.constructor.FLAGS[s], ...e);
        return t;
      }
      toArray(...e) {
    ...
    (function (e) {
      ...
      (t.resolve = function () {
        ...
        (t.dirname = function (e) {
          ...
          for (
            var t = e.charCodeAt(0), s = 47 === t, i = -1, n = !0, r = e.length - 1;
            r >= 1;
            --r
          )
        ...
        (t.basename = function (e, t) {
          ...
          return (
            t && s.substr(-1 * t.length) === t && (s = s.substr(0, s.length - t.length)),
            s
          );
        }),
  ...
  function (e, t, s) {
    ...
    e.exports = class ReactionEmoji {
      constructor(e, t) {
        Object.defineProperty(this, 'client', { value: e.message.client }),
          (this.reaction = e),
          (this.name = t.name),
          (this.id = t.id),
          (this.animated = t.animated || !1);
      }
      get createdTimestamp() {
      ...
      get url() {
        return this.id
          ? i.Endpoints.CDN(this.client.options.http.cdn).Emoji(
              this.id,
              this.animated ? 'gif' : 'png',
            )
          : null;
  ...
  function (e, t, s) {
    ...
    class Guild {
      ...
      setup(e) {
        if (
          ...
          (this.defaultMessageNotifications =
            u.DefaultMessageNotifications[e.default_message_notifications] ||
            e.default_message_notifications),
          (this.systemChannelFlags = new g(e.system_channel_flags).freeze()),
        ...
        if (e.presences) for (const t of e.presences) this._setPresence(t.user.id, t);
        if (((this._rawVoiceStates = new d()), e.voice_states))
      ...
      get iconURL() {
        return this.icon
          ? u.Endpoints.Guild(this).Icon(this.client.options.http.cdn, this.icon)
          : null;
      }
      get bannerURL() {
        return this.banner
          ? u.Endpoints.Guild(this).Banner(this.client.options.http.cdn, this.banner)
          : null;
      }
      get nameAcronym() {
      ...
      get splashURL() {
        return this.splash
          ? u.Endpoints.Guild(this).Splash(this.client.options.http.cdn, this.splash)
          : null;
      }
      get owner() {
      ...
      fetchBans(e = !1) {
        return e
          ? this.client.rest.methods.getGuildBans(this)
          : this.client.rest.methods.getGuildBans(this).then(e => {
              const t = new d();
      ...
      fetchIntegrations() {
        return this.client.rest.methods
          ...
          .then(e =>
            e.reduce((e, t) => e.set(t.id, new c(this.client, t, this)), new d()),
          );
      }
      createIntegration(e, t) {
        return this.client.rest.methods.createIntegration(this, e, t).then(() => this);
      }
      fetchInvites() {
      ...
      fetchVanityCode() {
        return this.features.includes('VANITY_URL')
          ? this.client.rest.methods.getGuildVanityCode(this)
          : Promise.reject(
              new Error('This guild does not have the VANITY_URL feature enabled.'),
            );
      }
      fetchWebhooks() {
      ...
      addMember(e, t) {
        return (
          (e = this.client.resolver.resolveUserID(e)),
          this.members.has(e)
            ? Promise.resolve(this.members.get(e))
      ...
      fetchMember(e, t = !0) {
        ...
        return i && i.joinedTimestamp
          ? Promise.resolve(i)
          : this.client.rest.methods.getGuildMember(this, s, t);
      }
      fetchMembers(e = '', t = 0) {
        return new Promise((s, i) => {
          if (this.memberCount === this.members.size) return void s(this);
          this.client.ws.send({
            op: u.OPCodes.REQUEST_GUILD_MEMBERS,
            d: { guild_id: this.id, query: e, limit: t },
          });
          const n = (e, t) => {
            t.id === this.id &&
              (this.memberCount === this.members.size || e.length < 1e3) &&
              (this.client.removeListener(u.Events.GUILD_MEMBERS_CHUNK, n), s(this));
          };
          this.client.on(u.Events.GUILD_MEMBERS_CHUNK, n),
            this.client.setTimeout(
      ...
      edit(e, t) {
        ...
        return (
          ...
          void 0 !== e.afkChannel &&
            (s.afk_channel_id = this.client.resolver.resolveChannelID(e.afkChannel)),
          ...
          void 0 !== e.banner && (s.banner = e.banner),
          ...
          void 0 !== e.defaultMessageNotifications &&
            (s.default_message_notifications =
              'string' == typeof e.defaultMessageNotifications
                ? u.DefaultMessageNotifications.indexOf(e.defaultMessageNotifications)
                : Number(e.defaultMessageNotifications)),
          void 0 !== e.systemChannelFlags &&
            (s.system_channel_flags = g.resolve(e.systemChannelFlags)),
      ...
      setSplash(e) {
        return this.client.resolver.resolveImage(e).then(e => this.edit({ splash: e }));
      }
      setPosition(e, t) {
        return this.client.user.bot
          ? Promise.reject(
              new Error('Setting guild position is only available for user accounts'),
            )
      ...
      ban(e, t = {}) {
        return (
          'number' == typeof t
            ...
            : 'string' == typeof t && (t = { reason: t, 'delete-message-days': 0 }),
      ...
      createChannel(e, t, s, i) {
        return (
          (t && 'string' != typeof t) ||
            ...
            (t = { type: t, permissionOverwrites: s, reason: i })),
          this.client.rest.methods.createChannel(this, e, t)
        );
      }
      setChannelPositions(e) {
        return (
          (e = e.map(({ channel: e, position: t }) => ({ id: e.id || e, position: t }))),
          this.client.rest.methods.setChannelPositions(this.id, e)
        );
      }
      setRolePositions(e) {
        return (
          (e = e.map(({ role: e, position: t }) => ({ id: e.id || e, position: t }))),
      ...
      createEmoji(e, t, s, i) {
        return 'string' == typeof e && e.startsWith('data:')
          ...
          : this.client.resolver
              .resolveImage(e)
              .then(e => this.client.rest.methods.createEmoji(this, e, t, s, i));
      }
      deleteEmoji(e, t) {
        if (('string' == typeof e && (e = this.emojis.get(e)), !(e instanceof a)))
      ...
      equals(e) {
        let t =
          ...
          this.large === e.large &&
          this.icon === e.icon &&
          m.arraysEqual(this.features, e.features) &&
      ...
      _addMember(e, t = !0) {
        ...
        return (
          this.client.ws.connection.status === u.Status.READY &&
            t &&
            !s &&
            this.client.emit(u.Events.GUILD_MEMBER_ADD, i),
          i
        );
      }
      _updateMember(e, t) {
        const s = m.cloneObject(e);
        t.premium_since &&
          (e.premiumSinceTimestamp = new Date(t.premium_since).getTime()),
          t.roles && (e._roles = t.roles),
          void 0 !== t.nick && (e.nickname = t.nick);
        const i =
          e.nickname !== s.nickname ||
          e.premiumSinceTimestamp !== s.premiumSinceTimestamp ||
          !m.arraysEqual(e._roles, s._roles);
        return (
          this.client.ws.connection.status === u.Status.READY &&
            i &&
            this.client.emit(u.Events.GUILD_MEMBER_UPDATE, s, e),
          { old: s, mem: e }
        );
      }
      _removeMember(e) {
      ...
      _memberSpeakUpdate(e, t) {
        ...
        s &&
          s.speaking !== t &&
          ((s.speaking = t), this.client.emit(u.Events.GUILD_MEMBER_SPEAKING, s, t));
      }
      _setPresence(e, t) {
      ...
      _sortPositionWithID(e) {
        return e.sort((e, t) =>
          e.position !== t.position
            ? e.position - t.position
            : n.fromString(t.id).sub(n.fromString(e.id)).toNumber(),
        );
      }
    }
    Object.defineProperty(Guild.prototype, 'defaultChannel', {
      ...
      (Guild.prototype.allowDMs = i.deprecate(
        Guild.prototype.allowDMs,
        'Guild#allowDMs: userbot methods will be removed',
      )),
      ...
      (Guild.prototype.deleteEmoji = i.deprecate(
        Guild.prototype.deleteEmoji,
        'Guild#deleteEmoji: use Emoji#delete instead',
      )),
      (e.exports = Guild);
  },
  function (e, t, s) {
      ...
      e.exports = class Webhook extends i {
        ...
        setup(e) {
          (this.name = e.name),
            ...
            (this.avatar = e.avatar),
            (this.id = e.id),
            (this.type = l.WebhookTypes[e.type]),
        ...
        get createdTimestamp() {
          return h.deconstruct(this.id).timestamp;
        }
        get createdAt() {
          return new Date(this.createdTimestamp);
        }
        get avatarURL() {
          return this.avatar
            ? l.Endpoints.CDN(this.client.options.http.cdn).Avatar(this.id, this.avatar)
            : null;
        }
        get url() {
          return (
            `${this.client.options.http.host}/api/v${this.client.options.http.version}` +
            l.Endpoints.Webhook(this.id, this.token)
          );
        }
        send(e, s) {
          if (
            (s || 'object' != typeof e || e instanceof Array
              ? s || (s = {})
              : ((s = e), (e = '')),
            s instanceof o && (s = { files: [s] }),
            s instanceof a && (s = { embeds: [s] }),
            e)
          ) {
            ...
            t && 'object' != typeof t && (t = {}),
              void 0 === i ||
                ...
                ((e = r.escapeMarkdown(e, !0)),
                (e = `\`\`\`${('boolean' != typeof i && i) || ''}\n${e}\n\`\`\``),
                t &&
                  ((t.prepend = `\`\`\`${('boolean' != typeof i && i) || ''}\n`),
                  (t.append = '\n```'))),
              (n || (void 0 === n && this.client.options.disableEveryone)) &&
                (e = e.replace(/@(everyone|here)/g, '@​$1')),
              t && (e = r.splitMessage(e, t));
          }
          if (
            (s.file && (s.files ? s.files.push(s.file) : (s.files = [s.file])), s.embeds)
          ) {
            const e = [];
            for (const t of s.embeds) t.file && e.push(t.file);
            s.files ? s.files.push(...e) : (s.files = e);
          }
          if ((s.embeds && (s.embeds = s.embeds.map(e => new a(e).toJSON())), s.files)) {
            for (let e = 0; e < s.files.length; e++) {
              let i = s.files[e];
              ('string' == typeof i || t.isBuffer(i)) && (i = { attachment: i }),
                i.name
                  ? i instanceof o && (i = i.file)
                  : 'string' == typeof i.attachment
                  ? (i.name = n.basename(i.attachment))
                  : i.attachment && i.attachment.path
                  ? (i.name = n.basename(i.attachment.path))
                  : i instanceof o
                  ? (i = { attachment: i.file, name: n.basename(i.file) || 'file.jpg' })
                  : (i.name = 'file.jpg'),
                (s.files[e] = i);
            }
            return Promise.all(
            ...
            ).then(t => this.client.rest.methods.sendWebhookMessage(this, e, s, t));
          }
        ...
        sendFile(e, t, s, i = {}) {
          return this.send(s, Object.assign(i, { file: { attachment: e, name: t } }));
        }
        sendCode(e, t, s = {}) {
          return this.send(t, Object.assign(s, { code: e }));
        }
        ...
        edit(e = this.name, t) {
          return (
            'object' != typeof e &&
              (((e, ...t) =>
                console.warn(
                  'Webhook#edit: Use options object instead of separate parameters.',
                  t,
                ))(),
              (e = { name: e, avatar: t }),
              (t = void 0)),
            e.channel &&
              ((e.channel_id = this.client.resolver.resolveChannelID(e.channel)),
              (e.channel = void 0)),
            e.avatar
              ? this.client.resolver
                  .resolveImage(e.avatar)
                  .then(
                    s => (
                      (e.avatar = s), this.client.rest.methods.editWebhook(this, e, t)
                    ),
                  )
              : this.client.rest.methods.editWebhook(this, e, t)
          );
        }
        delete(e) {
    ...
    class TextChannel extends i {
      ...
      createWebhook(e, t, s) {
        return 'string' == typeof t && t.startsWith('data:')
          ...
          : this.client.resolver
              .resolveImage(t)
              .then(t => this.client.rest.methods.createWebhook(this, e, t, s));
      }
    ...
    (R.toInt = function () {
      ...
      (R.divide = function (e) {
        ...
        if (s)
          return this.unsigned ||
            ...
            -1 !== e.high
            ? h(
                (this.unsigned ? s.div_u : s.div_s)(this.low, this.high, e.low, e.high),
                s.get_high(),
                this.unsigned,
              )
            : this;
      ...
      (R.modulo = function (e) {
        return (
          ...
          s
            ? h(
                (this.unsigned ? s.rem_u : s.rem_s)(this.low, this.high, e.low, e.high),
                s.get_high(),
                this.unsigned,
              )
      ...
      (R.shiftLeft = function (e) {
        return (
          ...
          0 == (e &= 63)
            ? this
            : e < 32
            ? h(this.low << e, (this.high << e) | (this.low >>> (32 - e)), this.unsigned)
      ...
      (R.shiftRight = function (e) {
        return (
          ...
          0 == (e &= 63)
            ? this
            : e < 32
            ? h((this.low >>> e) | (this.high << (32 - e)), this.high >> e, this.unsigned)
      ...
      e.exports = class ClientDataResolver {
        ...
        resolveFile(e) {
          return e instanceof t
            ...
            : 'string' == typeof e
            ? /^https?:\/\//.test(e)
              ? r.get(e).then(e => (e.body instanceof t ? e.body : t.from(e.text)))
              : new Promise((t, s) => {
                  const r = i.resolve(e);
                  n.stat(r, (e, i) =>
                    e
    ...
    e.exports = class Collector extends n {
      constructor(e, t, s = {}) {
        super(),
          ...
          s.time &&
            (this._timeout = this.client.setTimeout(() => this.stop('time'), s.time)),
          s.idle &&
            (this._idletimeout = this.client.setTimeout(() => this.stop('idle'), s.idle));
      }
      _handle(...e) {
      ...
      stop(e = 'user') {
        this.ended ||
          ...
          this._idletimeout &&
            (this.client.clearTimeout(this._idletimeout), (this._idletimeout = null)),
          (this.ended = !0),
          this.cleanup(),
    ...
    e.exports = class Integration {
      constructor(e, t, s) {
        Object.defineProperty(this, 'client', { value: e }),
          ...
          (this.role = this.guild.roles.get(t.role_id)),
          (this.user = this.client.dataManager.newUser(t.user)),
      ...
      sync() {
        return (
          ...
          this.client.rest.methods
            .syncIntegration(this)
            .then(() => ((this.syncing = !1), (this.syncedAt = Date.now()), this))
        );
      }
      edit(e, t) {
        return (
          'expireBehavior' in e &&
            ((e.expire_behavior = e.expireBehavior), (e.expireBehavior = void 0)),
          'expireGracePeriod' in e &&
            ((e.expire_grace_period = e.expireGracePeriod),
            (e.expireGracePeriod = void 0)),
          this.client.rest.methods
            .editIntegration(this, e, t)
            .then(() => (this._patch(e), this))
        );
      }
      delete(e) {
        return this.client.rest.methods.deleteIntegration(this, e).then(() => this);
      }
    };
  },
  function (e, t, s) {
    ...
    (OAuth2Application.prototype.reset = r.deprecate(
  ...
  function (e, t, s) {
    ...
    class GroupDMChannel extends i {
      ...
      get iconURL() {
        return this.icon
          ? o.Endpoints.Channel(this).Icon(this.client.options.http.cdn, this.icon)
          : null;
      }
      edit(e) {
        const t = {};
      ...
      setIcon(e) {
        return this.client.resolver.resolveImage(e).then(e => this.edit({ icon: e }));
      }
      setName(e) {
      ...
      static flattenErrors(e, t = '') {
        ...
        for (const i of Object.keys(e)) {
          ...
          e[i]._errors
            ...
            ? s.push(`${e[i].code ? `${e[i].code}: ` : ''}: ${e[i].message}`.trim())
            : 'string' == typeof e[i]
            ? s.push(e[i])
  ...
  function (e, t, s) {
    ...
    e.exports = class VoiceChannel extends i {
      ...
      get deletable() {
        return (
          super.deletable && this.permissionsFor(this.client.user).has(r.FLAGS.CONNECT)
        );
      }
      get joinable() {
        return !(
      ...
      join() {
        return this.client.browser
          ? Promise.reject(new Error('Voice connections are not available in browsers.'))
  ...
  function (e, t, s) {
    ...
    e.exports = class RESTManager {
      ...
      push(e, t) {
        return new Promise((s, i) => {
          e.push({ request: t, resolve: s, reject: i, retries: 0 });
        });
      }
      getRequestHandler() {
          ...
          if (t instanceof i) this.users = new i(t);
            ...
            for (const s of t) {
              ...
              t || (t = e.client.dataManager.newUser(s)),
                ...
                s.member &&
                  e.guild &&
                  !e.guild.members.has(s.id) &&
                  e.guild._addMember(Object.assign(s.member, { user: t }), !1);
            }
          }
  ...
  function (e, t, s) {
    ...
    e.exports = class MessageAttachment {
      ...
      get spoiler() {
        return i(this.url).startsWith('SPOILER_');
      }
    };
  },
  function (e, t, s) {
    ...
    e.exports = class MessageReaction {
      ...
      remove(e = this.message.client.user) {
        ...
        return s
          ? t.client.rest.methods.removeMessageReaction(t, this.emoji.identifier, s)
          : Promise.reject(
              new Error("Couldn't resolve the user ID to remove from the reaction."),
            );
      }
      removeAll() {
        const e = this.message;
        return e.client.rest.methods.removeMessageReactionEmoji(e, this.emoji.identifier);
      }
    ...
    e.exports = class ReactionCollector extends i {
      constructor(e, t, s = {}) {
        super(e.client, t, s),
          ...
          this.on('fullCollect', (e, t) => {
            this.users.set(t.id, t), this.total++;
          });
      }
      handle(e) {
      ...
      postCheck() {
        return this.options.max && this.total >= this.options.max
          ? 'limit'
          : this.options.maxEmojis && this.collected.size >= this.options.maxEmojis
          ? 'emojiLimit'
  ...
  function (e, t, s) {
    ...
    e.exports = class MessageCollector extends i {
      ...
      postCheck() {
        return this.options.maxMatches && this.collected.size >= this.options.maxMatches
          ? 'matchesLimit'
          : this.options.max && this.received >= this.options.max
          ? 'limit'
          : null;
      }
      cleanup() {
  ...
  function (e, t, s) {
    ...
    class GuildAuditLogs {
      constructor(e, t) {
        ...
        if (((this.integrations = new i()), t.integrations))
          for (const s of t.integrations)
            this.integrations.set(s.id, new o(e.client, s, e));
        this.entries = new i();
    ...
    class GuildAuditLogsEntry {
      constructor(e, t, s) {
        ...
        switch (
          ...
          (this.action = Object.keys(h).find(e => h[e] === s.action_type)),
          (this.reason = s.reason || null),
          (this.executor = t.client.users.get(s.user_id)),
          (this.changes = s.changes
            ? s.changes.map(e => ({ key: e.key, old: e.old_value, new: e.new_value }))
            : null),
          (this.id = s.id),
          (this.extra = null),
          s.action_type)
          ...
          case h.MESSAGE_UNPIN:
            this.extra = {
              channel: t.client.channels.get(s.options.channel_id) || {
                id: s.options.channel_id,
              },
        ...
        if (((this.target = null), i === l.UNKNOWN))
          this.changes.reduce((e, t) => ((e[t.key] = t.new || t.old), e), {}),
            (this.target.id = s.target_id);
        else if (i === l.USER && s.target_id)
          this.target = t.client.users.get(s.target_id);
        else if (i === l.GUILD) this.target = t.client.guilds.get(s.target_id);
        else if (i === l.WEBHOOK)
          this.target =
          ...
          (e.channel = { id: e.channel_id }), (this.target = new a(t.client, e));
        } else
          i === l.MESSAGE
            ? (this.target =
                s.action_type === h.MESSAGE_BULK_DELETE
                  ? t.channels.get(s.target_id) || { id: s.target_id }
                  : t.client.users.get(s.target_id))
            : i === l.INTEGRATION
            ? (this.target =
                e.integrations.get(s.target_id) ||
                new o(
                  t.client,
                  this.changes.reduce((e, t) => ((e[t.key] = t.new || t.old), e), {
                    id: s.target_id,
  ...
  function (e, t, s) {
    ...
    e.exports = class PermissionOverwrites {
      constructor(e, t) {
        Object.defineProperty(this, 'channel', { value: e }), t && this.setup(t);
      }
      setup(e) {
        (this.id = e.id),
          (this.type = e.type),
  ...
  function (e, t, s) {
    (function (t) {
        ...
        h = (function e() {
          ...
          try {
            ...
            return (
              ((e, ...t) =>
                console.warn(
                  'uws support is being removed in the next version of discord.js',
                  t,
                ))(0, 'DeprecationWarning', e),
              t
            );
          } catch (e) {
            return s(138);
      ...
      class WebSocketConnection extends n {
        ...
        debug(e) {
          return (
            e instanceof Error && (e = e.stack), this.manager.debug(`[connection] ${e}`)
          );
        }
        unpack(e) {
          return (
            ...
            l && 'string' != typeof e
              ? l.unpack(e)
              : (e instanceof t && (e = o.inflateSync(e).toString()), JSON.parse(e))
          );
        }
        pack(e) {
        ...
        connect(e = this.gateway, t = 0, s = !1) {
          ...
          if ('string' != typeof e)
            return this.debug(`Tried to connect to an invalid gateway: ${e}`), !1;
          (this.expectingClose = !1),
            (this.gateway = e),
        ...
        ackHeartbeat() {
          this.debug(
            `Heartbeat acknowledged, latency of ${Date.now() - this.lastPingTimestamp}ms`,
          ),
        ...
        identifyNew() {
          ...
          const e = Object.assign({ token: this.client.token }, this.client.options.ws),
  ...
  function (e, t, s) {
    ...
    class ClientUser extends i {
      ...
      setAvatar(e) {
        return this.client.resolver
          .resolveImage(e)
          .then(e => this.client.rest.methods.updateCurrentUser({ avatar: e }));
      }
      setPresence(e) {
        return new Promise(t => {
          ...
          e.game
            ? (((i = e.game).type = i.url && void 0 === i.type ? 1 : i.type || 0),
      ...
      setActivity(e, { url: t, type: s } = {}) {
        return e
          ? this.setPresence({ game: { name: e, type: s, url: t } }).then(e => e.presence)
          : this.setPresence({ game: null });
      }
      setAFK(e) {
      ...
      addFriend(e) {
        return (
          (e = this.client.resolver.resolveUser(e)), this.client.rest.methods.addFriend(e)
        );
      }
      removeFriend(e) {
        return (
      ...
      createGuild(e, t, s = null) {
        return 'string' == typeof s && s.startsWith('data:')
          ? this.client.rest.methods.createGuild({ name: e, icon: s, region: t })
          : this.client.resolver
              .resolveImage(s)
              .then(s =>
                this.client.rest.methods.createGuild({ name: e, icon: s, region: t }),
    ...
    (ClientUser.prototype.acceptInvite = l.deprecate(
      ...
      'ClientUser#acceptInvite: userbot methods will be removed',
    )),
  ...
  function (e, t, s) {
    ...
    e.exports = {
      Client: s(76),
      Shard: s(175),
      ShardClientUtil: s(176),
      ShardingManager: s(177),
      WebhookClient: s(178),
      BitField: s(23),
      Collection: s(4),
      Constants: s(0),
      DiscordAPIError: s(39),
      EvaluatedPermissions: s(7),
      MessageFlags: s(35),
      Permissions: s(7),
      Snowflake: s(6),
      SnowflakeUtil: s(6),
      SystemChannelFlags: s(54),
      Util: i,
      util: i,
      version: s(46).version,
      ...
      Attachment: s(24),
      CategoryChannel: s(41),
      Channel: s(12),
      ClientUser: s(61),
      ClientUserSettings: s(62),
      Collector: s(34),
      DMChannel: s(44),
      Emoji: s(21),
      Game: s(11).Game,
      ...
      Invite: s(13),
      Message: s(20),
      MessageAttachment: s(50),
      MessageCollector: s(53),
      MessageEmbed: s(32),
      MessageMentions: s(49),
      MessageReaction: s(51),
      NewsChannel: s(42),
      OAuth2Application: s(37),
      ClientOAuth2Application: s(37),
      PartialGuild: s(55),
      PartialGuildChannel: s(56),
      PermissionOverwrites: s(59),
      Presence: s(11).Presence,
      ReactionEmoji: s(26),
      ReactionCollector: s(52),
      RichEmbed: s(18),
      Role: s(9),
      StoreChannel: s(43),
      TextChannel: s(29),
      ...
      (t.toByteArray = function (e) {
        ...
        for (s = 0; s < u; s += 4)
          (t =
            ...
            (l[c++] = 255 & t);
        2 === a &&
          ((t = (n[e.charCodeAt(s)] << 2) | (n[e.charCodeAt(s + 1)] >> 4)),
          (l[c++] = 255 & t));
        1 === a &&
          ((t =
            (n[e.charCodeAt(s)] << 10) |
    ...
    function c(e, t, s) {
      for (var n, r, o = [], a = t; a < s; a += 3)
        (n = ((e[a] << 16) & 16711680) + ((e[a + 1] << 8) & 65280) + (255 & e[a + 2])),
          o.push(
            i[((r = n) >> 18) & 63] + i[(r >> 12) & 63] + i[(r >> 6) & 63] + i[63 & r],
          );
      return o.join('');
    }
  ...
  function (e, t, s) {
    ...
    class Snekfetch extends r.Extension {
      constructor(e, t, s = {}) {
        super(),
          (this.options = Object.assign({ version: 1, qs: n, followRedirects: !0 }, s)),
      ...
      attach(...e) {
        const t =
          this.data instanceof r.FormData ? this.data : (this.data = new r.FormData());
      ...
      send(e) {
        if (e instanceof r.FormData || r.shouldSendRaw(e)) this.data = e;
          ...
          t
            ...
            : (this.set('Content-Type', 'application/json'), (s = JSON.stringify)),
            (this.data = s(e));
        } else this.data = e;
        return this;
      }
      ...
      _finalizeRequest() {
        if (
          this.request &&
          ('HEAD' !== this.request.method && this.set('Accept-Encoding', 'gzip, deflate'),
          this.data &&
          ...
          this.request.path = `${e}?${this.options.qs.stringify(this.request.query)}${
            t ? `&${t}` : ''
          }`;
        }
      }
    ...
    e.exports = function (e, t, s, r) {
      ...
      for (var c = 0; c < h; ++c) {
        var u,
          ...
          g = e[c].replace(a, '%20'),
          f = g.indexOf(s);
        f >= 0 ? ((u = g.substr(0, f)), (d = g.substr(f + 1))) : ((u = g), (d = '')),
  ...
  function (module, exports, __webpack_require__) {
    (function (process) {
      const EventEmitter = __webpack_require__(17),
        ...
        Permissions = __webpack_require__(7),
        Util = __webpack_require__(5),
        RESTManager = __webpack_require__(47),
        ClientDataManager = __webpack_require__(90),
        ClientManager = __webpack_require__(91),
        ClientDataResolver = __webpack_require__(33),
        ClientVoiceManager = __webpack_require__(139),
        WebSocketManager = __webpack_require__(140),
        ActionsManager = __webpack_require__(141),
        Collection = __webpack_require__(4),
        Presence = __webpack_require__(11).Presence,
        ShardClientUtil = __webpack_require__(173),
        VoiceBroadcast = __webpack_require__(174);
      class Client extends EventEmitter {
        constructor(e = {}) {
          super(),
            !e.shardId &&
              'SHARD_ID' in Object({ __DISCORD_WEBPACK__: 'true' }) &&
              (e.shardId = Number(Object({ __DISCORD_WEBPACK__: 'true' }).SHARD_ID)),
            !e.shardCount &&
            ...
            !this.token && 'CLIENT_TOKEN' in Object({ __DISCORD_WEBPACK__: 'true' })
        ...
        sweepMessages(e = this.options.messageCacheLifetime) {
          ...
          if (e <= 0)
            return (
              this.emit('debug', "Didn't sweep messages - lifetime is unlimited"), -1
            );
          const t = 1e3 * e,
            s = Date.now();
          let i = 0,
        ...
        fetchApplication(e = '@me') {
          return (
            '@me' !== e &&
              ((e, ...t) =>
                console.warn('fetchApplication: use "@me" as an argument', t))(
                0,
                'DeprecationWarning',
              ),
  ...
  function (e, t, s) {
    ...
    e.exports = class RESTMethods {
        ...
        return new Promise((p, g) => {
          ...
          const f = e => {
            if (t instanceof Array) {
              ...
              !(function t(r, o) {
                const a =
                  o === r.length - 1 ? { tts: s, embed: n, files: u } : { tts: s };
                e.send(r[o], a)
                  .then(e => (i.push(e), o >= r.length - 1 ? p(i) : t(r, ++o)))
                  .catch(g);
              })(t, 0);
            } else
              this.rest
                ...
                .then(e => p(this.client.actions.MessageCreate.handle(e).message), g);
          };
          e instanceof d || e instanceof m ? this.createDM(e).then(f, g) : f(e);
        });
      }
      updateMessage(e, t, { flags: s, embed: i, code: n, reply: r } = {}) {
        if (
          (void 0 !== t && (t = this.client.resolver.resolveString(t)),
          void 0 !== s && (s = R.resolve(s)),
          void 0 === n ||
            ('boolean' == typeof n && !0 !== n) ||
            ((t = h.escapeMarkdown(this.client.resolver.resolveString(t), !0)),
            (t = `\`\`\`${('boolean' != typeof n && n) || ''}\n${t}\n\`\`\``)),
          r && 'dm' !== e.channel.type)
        ) {
          const e = this.client.resolver.resolveUserID(r);
          t = `${`<@${r instanceof m && r.nickname ? '!' : ''}${e}>`}${
            t ? `, ${t}` : ''
          }`;
        }
        return (
          i instanceof u && (i = i.toJSON()),
          this.rest
            .makeRequest('patch', a.Message(e), !0, { content: t, embed: i, flags: s })
            .then(e => this.client.actions.MessageUpdate.handle(e).updated)
        );
      }
      deleteMessage(e) {
        return this.rest.makeRequest('delete', a.Message(e), !0).then(
          () =>
      ...
      bulkDeleteMessages(e, t) {
        return this.rest
          .makeRequest('post', a.Channel(e).messages.bulkDelete, !0, { messages: t })
          .then(
            () =>
              this.client.actions.MessageDeleteBulk.handle({ channel_id: e.id, ids: t })
                .messages,
          );
      }
      search(e, t) {
        ...
        t.channel && (t.channel = this.client.resolver.resolveChannelID(t.channel)),
          ...
          t.mentions &&
            (t.mentions = this.client.resolver.resolveUserID(t.options.mentions)),
          (t = {
            content: t.content,
            max_id: t.maxID,
            min_id: t.minID,
        ...
        for (const e of Object.keys(t)) void 0 === t[e] && delete t[e];
        ...
        return this.rest.makeRequest('get', `${r}?${s}`, !0).then(e => {
          const t = e.messages.map(e =>
            e.map(e => new p(this.client.channels.get(e.channel_id), e, this.client)),
          );
        ...
        return this.rest
          .makeRequest(
            ...
            !0,
            {
              ...
              bitrate: l,
              user_limit: h,
              parent_id: u instanceof b ? u.id : u,
        ...
        return (
          ...
          e
            ? this.rest
                ...
                .then(
                  t => (
                    (t.id = e.id), this.client.actions.ChannelDelete.handle(t).channel
                  ),
                )
      ...
      updateChannel(e, t, s) {
        ...
        return (
          ...
          (i.parent_id = t.parent instanceof b ? t.parent.id : t.parent),
          (i.permission_overwrites = t.permissionOverwrites
            ? c.call(this, t.permissionOverwrites, e.guild)
            : void 0),
          (i.rate_limit_per_user =
            void 0 !== t.rateLimitPerUser ? t.rateLimitPerUser : e.rateLimitPerUser),
          this.rest
      ...
      leaveGuild(e) {
        return e.ownerID === this.client.user.id
          ...
          : this.rest
              ...
              .then(() => this.client.actions.GuildDelete.handle({ id: e.id }).guild);
      }
      createGuild(e) {
        return (
      ...
      getUser(e, t) {
        return this.rest
          ...
          .then(e =>
            t ? this.client.actions.UserGet.handle(e).user : new d(this.client, e),
          );
      }
      ...
      deleteGuildRole(e, t) {
        return this.rest
          .makeRequest('delete', a.Guild(e.guild).Role(e.id), !0, void 0, void 0, t)
          .then(
            () =>
      ...
      getChannelMessages(e, t = {}) {
        ...
        return (
          s.length > 0 && (i += `?${s.join('&')}`), this.rest.makeRequest('get', i, !0)
        );
      }
      ...
      putGuildMember(e, t, s) {
        ...
        return this.rest
          .makeRequest('put', a.Guild(e).Member(t), !0, s)
      ...
      getGuildMember(e, t, s) {
        return this.rest
          .makeRequest('get', a.Guild(e).Member(t), !0)
          .then(t =>
            s ? this.client.actions.GuildMemberGet.handle(e, t).member : new m(e, t),
          );
      }
      updateGuildMember(e, t, s) {
        ...
        t.roles &&
          (t.roles = [...new Set(t.roles.map(e => (e instanceof g ? e.id : e)))]);
        let i = a.Member(e);
        ...
        return new Promise((i, n) => {
          ...
          const r = (s, n) => {
            n.id === e.id &&
              ...
              (this.client.removeListener(o.Events.GUILD_MEMBER_UPDATE, r), i(n));
          };
      ...
      removeMemberRole(e, t, s) {
        return new Promise((i, n) => {
          ...
          return this.rest
            .makeRequest('delete', a.Member(e).Role(t.id), !0, void 0, void 0, s)
            .catch(e => {
              this.client.removeListener(o.Events.GUILD_MEMBER_UPDATE, r),
                this.client.clearTimeout(l),
                n(e);
      ...
      unbanGuildMember(e, t, s) {
        return new Promise((i, n) => {
          ...
          this.rest
            .makeRequest('delete', `${a.Guild(e).bans}/${r}`, !0, void 0, void 0, s)
            .catch(e => {
              this.client.removeListener(o.Events.GUILD_BAN_REMOVE, l),
                this.client.clearTimeout(h),
                n(e);
      ...
      getGuildBans(e) {
        return this.rest.makeRequest('get', a.Guild(e).bans, !0).then(e =>
          e.reduce(
            (e, t) => (
              e.set(t.user.id, {
                reason: t.reason,
      ...
      createEmoji(e, t, s, i, n) {
        ...
        return (
          ...
          this.rest
            ...
            .then(t => this.client.actions.GuildEmojiCreate.handle(e, t).emoji)
        );
      }
      updateEmoji(e, t, s) {
        const i = {};
        return (
          ...
          this.rest
            .makeRequest('patch', a.Guild(e.guild).Emoji(e.id), !0, i, void 0, s)
            .then(t => this.client.actions.GuildEmojiUpdate.handle(e, t).emoji)
        );
      }
      deleteEmoji(e, t) {
        return this.rest
          .makeRequest('delete', a.Guild(e.guild).Emoji(e.id), !0, void 0, t)
          .then(() => this.client.actions.GuildEmojiDelete.handle(e).emoji);
      }
      ...
      editWebhook(e, t, s) {
        ...
        return (
          t.channel_id || s
            ? ((i = a.Webhook(e.id)), (n = !0))
            : ((i = a.Webhook(e.id, e.token)), (n = !1)),
          this.rest
            .makeRequest('patch', i, n, t, void 0, s)
            .then(
              t => (
                (e.name = t.name), (e.avatar = t.avatar), (e.channelID = t.channel_id), e
              ),
            )
        );
      }
      ...
      sendWebhookMessage(
        ...
        return new Promise((l, h) => {
          if (((r = r || e.name), t instanceof Array)) {
            const s = [];
            !(function t(r, a) {
              const c = a === r.length - 1 ? { tts: i, embeds: n, files: o } : { tts: i };
              e.send(r[a], c)
      ...
      fetchMentions(e) {
        return (
          ...
          h.mergeDefault({ limit: 25, roles: !0, everyone: !0, guild: null }, e),
          this.rest
            .makeRequest(
              'get',
      ...
      setRolePositions(e, t) {
        return this.rest.makeRequest('patch', a.Guild(e).roles, !0, t).then(
          () =>
      ...
      setChannelPositions(e, t) {
        return this.rest.makeRequest('patch', a.Guild(e).channels, !0, t).then(
          () =>
      ...
      removeMessageReaction(e, t, s) {
        ...
        return this.rest.makeRequest('delete', i, !0).then(
          () =>
      ...
      removeMessageReactionEmoji(e, t) {
        const s = a.Message(e).Reaction(t);
        return this.rest.makeRequest('delete', s, !0).then(
          () =>
      ...
      resetApplication(e) {
        return this.rest
          ...
          .then(() =>
            this.rest.makeRequest('post', a.OAUTH2.Application(e).resetSecret, !0),
          )
          .then(e => new v(this.client, e));
      }
      setNote(e, t) {
      ...
      getIntegrations(e) {
        return this.rest.makeRequest('get', o.Endpoints.Guild(e.id).integrations, !0);
      }
      createIntegration(e, t, s) {
        return this.rest.makeRequest(
          'post',
          o.Endpoints.Guild(e.id).integrations,
          !0,
          t,
          void 0,
          s,
      ...
      syncIntegration(e) {
        return this.rest.makeRequest(
          'post',
          o.Endpoints.Guild(e.guild.id).Integration(e.id),
          !0,
        );
      }
      editIntegration(e, t, s) {
        return this.rest.makeRequest(
          'patch',
          o.Endpoints.Guild(e.guild.id).Integration(e.id),
          !0,
  ...
  function (e, t, s) {
    ...
    e.exports = class Team {
      constructor(e, t) {
        Object.defineProperty(this, 'client', { value: e }), this._patch(t);
      }
      _patch(e) {
        (this.id = e.id),
          (this.name = e.name),
      ...
      get iconURL() {
        return this.icon
          ? o.Endpoints.CDN(this.client.options.http.cdn).TeamIcon(this.id, this.icon)
          : null;
      }
      toString() {
        return this.name;
            ...
            e.request.gen().end((s, i) => {
              if (
                ...
                429 === s.status
                  ...
                  ? e.retries === this.client.options.retryLimit
                    ? (e.reject(s), t())
                    : (e.retries++,
                      this.queue.unshift(e),
                      this.client.setTimeout(t, 1e3 + this.client.options.restTimeOffset))
                  : (e.reject(
        ...
        super.handle(),
          0 !== this.queue.length &&
            (((this.remaining <= 0 || this.globalLimit) &&
              ...
              (this.execute(this.queue.shift()), this.remaining--, this.handle()));
      }
    };
  },
  function (e, t, s) {
  ...
  function (e, t, s) {
    ...
    e.exports = class ClientDataManager {
      ...
      newChannel(e, t) {
        ...
        else if (e.type === i.ChannelTypes.GROUP_DM) n = new g(this.client, e);
        else if (((t = t || this.client.guilds.get(e.guild_id)), s))
      ...
      newEmoji(e, t) {
        ...
        if (e && !s) {
          let s = new a(t, e);
          return (
            this.client.emit(i.Events.GUILD_EMOJI_CREATE, s), t.emojis.set(s.id, s), s
          );
        }
      ...
      killEmoji(e) {
        e instanceof a &&
          e.guild &&
          (this.client.emit(i.Events.GUILD_EMOJI_DELETE, e), e.guild.emojis.delete(e.id));
      }
      killGuild(e) {
        const t = this.client.guilds.has(e.id);
    ...
    e.exports = class WebSocketPacketManager {
      constructor(e) {
        (this.ws = e),
          (this.handlers = {}),
          (this.queue = []),
          this.register(i.WSEvents.READY, s(93)),
          this.register(i.WSEvents.RESUMED, s(95)),
          this.register(i.WSEvents.GUILD_CREATE, s(96)),
          this.register(i.WSEvents.GUILD_DELETE, s(97)),
          this.register(i.WSEvents.GUILD_UPDATE, s(98)),
          this.register(i.WSEvents.GUILD_BAN_ADD, s(99)),
          this.register(i.WSEvents.GUILD_BAN_REMOVE, s(100)),
          this.register(i.WSEvents.GUILD_MEMBER_ADD, s(101)),
          this.register(i.WSEvents.GUILD_MEMBER_REMOVE, s(102)),
          this.register(i.WSEvents.GUILD_MEMBER_UPDATE, s(103)),
          this.register(i.WSEvents.GUILD_ROLE_CREATE, s(104)),
          this.register(i.WSEvents.GUILD_ROLE_DELETE, s(105)),
          this.register(i.WSEvents.GUILD_ROLE_UPDATE, s(106)),
          this.register(i.WSEvents.GUILD_EMOJIS_UPDATE, s(107)),
          this.register(i.WSEvents.GUILD_MEMBERS_CHUNK, s(108)),
          this.register(i.WSEvents.GUILD_INTEGRATIONS_UPDATE, s(109)),
          this.register(i.WSEvents.INVITE_CREATE, s(110)),
          this.register(i.WSEvents.INVITE_DELETE, s(111)),
          this.register(i.WSEvents.CHANNEL_CREATE, s(112)),
          this.register(i.WSEvents.CHANNEL_DELETE, s(113)),
          this.register(i.WSEvents.CHANNEL_UPDATE, s(114)),
          this.register(i.WSEvents.CHANNEL_PINS_UPDATE, s(115)),
          this.register(i.WSEvents.PRESENCE_UPDATE, s(116)),
          this.register(i.WSEvents.USER_UPDATE, s(117)),
          this.register(i.WSEvents.USER_NOTE_UPDATE, s(118)),
          this.register(i.WSEvents.USER_SETTINGS_UPDATE, s(119)),
          this.register(i.WSEvents.USER_GUILD_SETTINGS_UPDATE, s(120)),
          this.register(i.WSEvents.VOICE_STATE_UPDATE, s(121)),
          this.register(i.WSEvents.TYPING_START, s(122)),
          this.register(i.WSEvents.MESSAGE_CREATE, s(123)),
          this.register(i.WSEvents.MESSAGE_DELETE, s(124)),
          this.register(i.WSEvents.MESSAGE_UPDATE, s(125)),
          this.register(i.WSEvents.MESSAGE_DELETE_BULK, s(126)),
          this.register(i.WSEvents.VOICE_SERVER_UPDATE, s(127)),
          this.register(i.WSEvents.GUILD_SYNC, s(128)),
          this.register(i.WSEvents.RELATIONSHIP_ADD, s(129)),
          this.register(i.WSEvents.RELATIONSHIP_REMOVE, s(130)),
          this.register(i.WSEvents.MESSAGE_REACTION_ADD, s(131)),
          this.register(i.WSEvents.MESSAGE_REACTION_REMOVE, s(132)),
          this.register(i.WSEvents.MESSAGE_REACTION_REMOVE_EMOJI, s(133)),
          this.register(i.WSEvents.MESSAGE_REACTION_REMOVE_ALL, s(134)),
          this.register(i.WSEvents.WEBHOOKS_UPDATE, s(135));
      }
      get client() {
  ...
  function (e, t, s) {
    ...
    e.exports = class ReadyHandler extends i {
      handle(e) {
        ...
        if (s.notes)
          for (const e of Object.keys(s.notes)) {
            let i = s.notes[e];
        ...
        const r = t.setTimeout(() => {
          ...
          o = s.guilds.length;
        0 !== t.getMaxListeners() && t.setMaxListeners(t.getMaxListeners() + o),
          t.once('ready', () => {
            t.syncGuilds(),
              0 !== t.getMaxListeners() && t.setMaxListeners(t.getMaxListeners() - o),
              t.clearTimeout(r);
          });
        const a = this.packetManager.ws;
        (a.sessionID = s.session_id),
          t.emit('debug', `READY ${a.sessionID}`),
          a.checkIfReady();
      }
    };
  },
    ...
    e.exports = class ResumedHandler extends i {
      handle() {
        const e = this.packetManager.client,
          t = e.ws.connection;
        (t.status = n.Status.READY), this.packetManager.handleQueue();
        const s = t.sequence - t.closeSequence;
        t.debug(`RESUMED | replayed ${s} events.`),
          e.emit(n.Events.RESUME, s),
          t.heartbeat();
      }
    };
  },
  ...
  function (e, t, s) {
    const i = s(1);
    e.exports = class InviteCreateHandler extends i {
      handle(e) {
        const t = this.packetManager.client,
          s = e.d;
        t.actions.InviteCreate.handle(s);
      }
    };
  },
  function (e, t, s) {
    const i = s(1);
    e.exports = class InviteDeleteHandler extends i {
      handle(e) {
        const t = this.packetManager.client,
          s = e.d;
        t.actions.InviteDelete.handle(s);
      }
    };
  },
  function (e, t, s) {
  ...
  function (e, t, s) {
    ...
    e.exports = class ChannelPinsUpdate extends i {
      handle(e) {
        ...
        i &&
          r &&
          ((i.lastPinTimestamp = r.getTime() || null),
      ...
      handle(e) {
        ...
        if ((i.patch(s.user), i.equals(a) || t.emit(n.Events.USER_UPDATE, a, i), o)) {
          ...
          if (
            (e ||
              'offline' === s.status ||
              ((e = o._addMember({ user: i, roles: s.roles, deaf: !1, mute: !1 }, !1)),
        ...
        if (i) {
          ...
          if (e) {
            ...
            e.voiceChannel &&
              ...
              e.user.id === t.user.id && t.emit('self.voiceStateUpdate', s);
            const o = t.channels.get(s.channel_id);
            o && (o.members.set(e.id, e), e.guild.channels.set(s.channel_id, o)),
              (e.serverMute = s.mute),
              (e.serverDeaf = s.deaf),
              (e.selfMute = s.self_mute),
              (e.selfDeaf = s.self_deaf),
              (e.selfStream = s.self_stream || !1),
    ...
    e.exports = class RelationshipRemoveHandler extends i {
      handle(e) {
        ...
        2 === s.type
          ...
          : 1 === s.type && t.user.friends.has(s.id) && t.user.friends.delete(s.id);
      }
    };
  },
  function (e, t, s) {
  ...
  function (e, t, s) {
    ...
    e.exports = class MessageReactionRemoveEmoji extends i {
      handle(e) {
        const t = this.packetManager.client,
          s = e.d;
        t.actions.MessageReactionRemoveEmoji.handle(s);
      }
    };
  },
  function (e, t, s) {
    ...
    e.exports = class WebSocketManager extends i {
      ...
      destroy() {
        return this.connection
          ...
          : (this.debug('Attempted to destroy WebSocket but no connection exists!'), !1);
      }
      send(e) {
        this.connection
  ...
  function (e, t, s) {
    ...
    e.exports = class MessageDeleteBulkAction extends i {
      handle(e) {
        ...
        return (
          t.size > 0 && this.client.emit(r.Events.MESSAGE_BULK_DELETE, t), { messages: t }
        );
      }
    };
  },
  ...
  function (e, t, s) {
    ...
    e.exports = class MessageReactionRemoveEmoji extends i {
      handle(e) {
        ...
        if (!s) return !1;
        if (!e.emoji) return !1;
        const i = s._removeReaction(e.emoji);
        return (
          i && this.client.emit(n.Events.MESSAGE_REACTION_REMOVE_EMOJI, i),
          { message: s, reaction: i }
        );
      }
    };
  },
    ...
    e.exports = class ChannelDeleteAction extends i {
      ...
      handle(e) {
        ...
        if (
          ...
          if (s.messages && !(s instanceof n))
            for (const e of s.messages.values()) e.deleted = !0;
          s.deleted = !0;
        }
        return { channel: s };
      }
    ...
    e.exports = class ChannelUpdateAction extends i {
      handle(e) {
        ...
        if (s) {
          ...
          return t.emit(h.Events.CHANNEL_UPDATE, i, s), { old: i, updated: s };
        }
        return { old: null, updated: null };
      }
    };
      ...
      handle(e) {
        ...
        if (s) {
          ...
          if (s.available && e.unavailable)
            return (
              (s.available = !1), t.emit(n.Events.GUILD_UNAVAILABLE, s), { guild: null }
            );
    ...
    e.exports = class GuildUpdateAction extends i {
      handle(e) {
        ...
        if (s) {
          ...
          return s.setup(e), t.emit(n.Events.GUILD_UPDATE, i, s), { old: i, updated: s };
        }
        return { old: null, updated: null };
      }
    };
  ...
  function (e, t, s) {
    ...
    e.exports = class InviteCreateAction extends i {
      handle(e) {
        const t = this.client,
          s = t.guilds.get(e.guild_id),
          i = t.channels.get(e.channel_id);
        if (s && i) {
          const o = Object.assign(e, { guild: s, channel: i }),
            a = new n(t, o);
  ...
  function (e, t, s) {
    ...
    e.exports = class GuildSync extends i {
      handle(e) {
        ...
        if (t) {
          if (e.presences) for (const s of e.presences) t._setPresence(s.user.id, s);
          if (e.members)
  ...
  function (e, t, s) {
    ...
    e.exports = class GuildEmojiDeleteAction extends i {
      handle(e) {
        return this.client.dataManager.killEmoji(e), (e.deleted = !0), { emoji: e };
      }
    };
  },
  function (e, t, s) {
    ...
    e.exports = class GuildEmojisUpdateAction extends i {
      handle(e) {
        ...
        for (const i of e.emojis) {
          ...
          e
            ? (s.delete(i.id),
              e.equals(i, !0) || this.client.actions.GuildEmojiUpdate.handle(e, i))
